...
import com.cesecsh.baselib.helper.DisplayHelper;
...
/**
 * BottomSheetDialog 在 {@link Dialog} 的基础上重新定制了 {@link #show()} 和 {@link #hide()} 时的动画效果, 使 {@link Dialog} 在界面底部升起和降下。
 * <p>
 * 提供了以下两种面板样式:
 * <ul>
...
public class BottomSheetDialog extends Dialog {
    ...
    /**
     * 生成列表类型的 {@link BottomSheetDialog} 对话框。
     */
    ...
    /**
     * 生成宫格类型的 {@link BottomSheetDialog} 对话框。
     */
