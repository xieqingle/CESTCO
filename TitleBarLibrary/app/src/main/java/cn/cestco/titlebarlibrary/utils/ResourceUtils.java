...
import cn.cestco.titlebarlibrary.TitleBarApplication;
...
public class ResourceUtils {
    public static Context getContext() {
        return TitleBarApplication.getContext();
    }

    public static Handler getHandler() {
        return TitleBarApplication.getHandler();
    }

    public static int getMainThreadId() {
        return TitleBarApplication.getMainThreadId();
    }
